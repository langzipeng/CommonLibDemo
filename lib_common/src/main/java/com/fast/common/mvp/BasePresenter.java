...
import com.fast.common.utils.Preconditions;
...
public abstract class BasePresenter<M extends IModel, V extends IView> implements IPresenter<V> {
    ...
    protected V getView() {
        Preconditions.checkNotNull(mView, IView.class.getName() + "%s cannot be null");
        return mView;
    }
    ...
    protected M getModel() {
        Preconditions.checkNotNull(mModel, IModel.class.getName() + "%s cannot be null");
        return mModel;
    }
